...
/*TODO import com.facebook.model.GraphUser;
...
public class PickerActivity extends FragmentActivity {
	...
	/*TODO private FriendPickerFragment friendPickerFragment;*/
	...
	private void finishActivity() {
		/*TODO if (friendPickerFragment != null && friendPickerFragment.getSelection().size() > 0) {
	...
	protected void onStart() {
	    ...
	    if (FRIEND_PICKER.equals(getIntent().getData())) {
	        try {
	            /*TODO friendPickerFragment.loadData(false);*/
	        } catch (Exception ex) {
	            onError(ex);
	        }
	    }
